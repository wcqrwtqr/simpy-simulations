...
RANDOM_SEED = 42
GAS_STATION_SIZE = 75000     # liters
THRESHOLD = 10             # Threshold for calling the tank truck (in %)
FUEL_TANK_SIZE = 30000        # liters
FUEL_TANK_LEVEL = [100, 25000]  # Min/max levels of fuel tanks (in liters)
REFUELING_SPEED = 300        # liters / second
...
gas_station = simpy.Resource(env, 5)
